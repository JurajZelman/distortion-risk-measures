$Title Distortion Reward Risk Optimization (PH transform)
...
Equations
    ...
    positiveReturns         .. Reward =g= 1;
    obj                     .. RRR*Reward =e= y("t1") +
    ...
    finalRisk               .. Risk =e= RRR*Reward;

Model definition
Model OptimalPortfolio /all/ ;
...
* Solving the model
Solve OptimalPortfolio using MINLP minimizing RRR;

Display p.l, w.l, x.l, y.l, Risk.l, Reward.l, RRR.l;

* Writing output data into the output file
Execute_Unload 'outdataPH5RRR.gdx';
Execute 'GDXXRW outdataPH5RRR.gdx squeeze=n var w.l rng=Sheet1!b2:k2' ;
Execute 'GDXXRW outdataPH5RRR.gdx var Risk.l rng=Sheet1!m3:m3';
Execute 'GDXXRW outdataPH5RRR.gdx var Reward.l rng=Sheet1!n3:n3';
