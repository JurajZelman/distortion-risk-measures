$Title Distortion Reward Risk Optimization (MINVAR)
...
Execute_Unload 'outdataMV5RRR.gdx';
Execute 'GDXXRW outdataMV5RRR.gdx squeeze=n var w.l rng=Sheet1!b2:k2' ;
Execute 'GDXXRW outdataMV5RRR.gdx var Risk.l rng=Sheet1!m3:m3';
Execute 'GDXXRW outdataMV5RRR.gdx var Reward.l rng=Sheet1!n3:n3';
